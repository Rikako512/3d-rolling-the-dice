...
public class CSVData : MonoBehaviour
{
    ...
    public GameObject datasetName2;
    public GameObject pointCount2;
    ...
    private void AssignLabels()
    {
      ...
      pointCount2.GetComponent<TextMeshProUGUI>().text = pointList.Count.ToString("0");

      // Update title according to inputfile name
      datasetName1.GetComponent<TextMeshProUGUI>().text = inputfile;
      datasetName2.GetComponent<TextMeshProUGUI>().text = inputfile;
    }
